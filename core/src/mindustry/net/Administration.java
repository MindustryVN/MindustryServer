...
public class Administration {
    ...
    public Administration() {
        ...
        addActionFilter(action -> {
            if (action.type != ActionType.breakBlock && action.type != ActionType.placeBlock
                    && action.type != ActionType.commandUnits && Config.antiSpam.bool() && !action.player.isLocal()) {
     ...
     * special commands. Note that commands (starting with /) are not filtered.
     */
    ...
    /**
     * Bans a player by IP; returns whether this player was already banned. If there
     * are players who at any point had this IP, they will be UUID banned as well.
     */
     ...
     * place. This method also unbans any player that was banned and had this IP.
     */
     ...
     * place. This also unbans all IPs the player used.
     */
     ...
     * or number. Creating a new Config instance implicitly adds it to the list of
     * server configs. This can be used for custom plugin configuration.
     */
